...
INPUT_TIME_EMPLOYEE_START = "0830"
INPUT_TIME_EMPLOYEE_STOP = "0900"
INPUT_TIME_SUPERVISOR_START = "1130"
INPUT_TIME_SUPERVISOR_STOP = "1200"
...
def print_calendar(outfilename, section, event_lines, is_supervisor):
    with open(outfilename, "wt") as outfile:
        ...
        outfile.write("PRODID:-//Hol2Ics//EN\n")
